...
/**
 * Platform-wide communications managed from the Content & Communication
 * Center: announcements, templates, and campaigns. Audience targeting is a
 * free-form JSON filter the delivery worker interprets.
 */
...
export class AnnouncementEntity extends AppBaseEntity {
  ...
  /** Audience filter, e.g. { planTier: 'pro' } or { all: true }. */
  ...
  /** Rough engagement metrics surfaced in the UI. */
